...
def visualize_img_json_file(json_file, 
    ...
    for idx, image in enumerate(images_random):
        ...
        # Save the image
        file_name = f"{idx}_{str(datetime.datetime.now()).replace(' ', '-')}.png"
...
if __name__ == "__main__":
    ...
    # The json file path
    # json_file = "./results/NoPlaymentLabels/day_noplayment_11092023_train_random_sampling_1000images_ADDED_ground-based_objects.json"
    # json_file = "./results/NoPlaymentLabels/day_noplayment_11092023_train_ADDED_ground-based_objects(threshold=0.3).json"
    json_file = "./results/NoPlaymentLabels/day_noplayment_11092023_val_ADDED_ground-based_objects(threshold=0.3).json"

    # The directory to save the images
    # dir_save = "./results/NoPlaymentLabels/added_annotations_images_dataset(1000_images)_threshold=0.3_with_resizing_(only_4Kimages)_checked_results"
    # dir_save = "./results/NoPlaymentLabels/test"
    # dir_save = "./results/NoPlaymentLabels/day_noplayment_11092023_train_ADDED_ground-based_objects_checked_results"
    dir_save = "./results/NoPlaymentLabels/day_noplayment_11092023_val_ADDED_ground-based_objects_checked_results"
