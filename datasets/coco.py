...
def build(image_set, args, img_dataset=None, ann_json_file=None):
    ...
    # img_folder, ann_file = PATHS[image_set] # COCO validation set, 2017. Add folder path and annotation file path
    
   
    # Read an image 
    # folder_path = img_folder + "uav/uav_96/000000103028.png"
